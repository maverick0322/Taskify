...
CREATE TABLE columns (id TEXT PRIMARY KEY, board_id TEXT, name TEXT, position INTEGER, created_at DATETIME, updated_at DATETIME, deleted_at DATETIME NULL);
CREATE TABLE tasks (id TEXT PRIMARY KEY, user_id TEXT, board_id TEXT, title TEXT, description TEXT, status TEXT, priority TEXT, due_date DATETIME NULL, created_at DATETIME, updated_at DATETIME, deleted_at DATETIME NULL);
