...
func syncTableSpecs() []syncTableSpec {
	return []syncTableSpec{
		...
		{name: "credit_card_statement_items", columns: []string{"id", "user_id", "statement_id", "transaction_id", "amount_cents", "created_at", "updated_at", "deleted_at"}},
		{name: "credit_card_payment_allocations", columns: []string{"id", "user_id", "statement_id", "payment_transaction_id", "amount_cents", "created_at", "updated_at", "deleted_at"}},
