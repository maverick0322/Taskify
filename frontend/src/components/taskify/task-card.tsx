...
export function TaskCard({
  ...
  return (
    <article className="group relative rounded-xl border border-border bg-card p-4 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 hover:border-primary/30 cursor-grab active:cursor-grabbing">
      {/* Header row */}
